...
<body>
    <table>
     ...
     <!-- ___________________________forum_____________________________________________-->
                ...
                <h3 style="text-align: center;">Add a Topic!</h3>
                <form method=post action="do_addtopic.php">
                    <p style="text-align: center;"><strong>Your E-Mail Address:</strong><br>
                    <input type="text" name="topic_owner" size=40 maxlength=150>
                    <p style="text-align: center;"><strong>Topic Title:</strong><br>
                    <input type="text" name="topic_title" size=40 maxlength=150>
                    <p style="text-align: center;"><strong>Post Text:</strong><br>
                    <textarea name="post_text" rows=8 cols=40 wrap=virtual></textarea>
                    <p style="text-align: center;"><input type="submit" name="submit!" value="Throw!"></p>
                </form>
