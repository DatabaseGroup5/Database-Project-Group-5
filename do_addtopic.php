    ...
    <table>
     ...
     <!-- ___________________________forum_____________________________________________-->
		 <?php
		  ...
		  mysqli_select_db($conn, "forum") or die(mysql_error());

		  //create and issue the first query
		  $add_topic = "INSERT INTO forum_topics values ('', '" . $_POST['topic_title'] ."', now(), '" . $_POST['topic_owner'] . "');";
		  mysqli_query($conn, $add_topic) or die(mysql_error());
		  ...
		  mysqli_query($conn, $add_post) or die(mysqli_error());
		  //dump topic title on a variable
		  $title = $_POST['topic_title'];
		  //create message for user
		  $msg = "<P>The <strong>$title</strong> topic has been created.</p>";
		  ...
		  <html>
		    ...
		    <body>
		      ...
		      <?php echo $msg; ?>
		      <a href="topiclist.php"> Wanna see the topics? </a>
		    </body>
		  </html>
